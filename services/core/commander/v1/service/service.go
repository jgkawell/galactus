...
import (
	chpb "github.com/jgkawell/galactus/api/gen/go/core/commander/v1"
...
// a new event in the eventer. The eventer will then broker the message to the correct data stream
