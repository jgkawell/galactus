...
type Registration struct {
	...
	Producers []*Producer `protobuf:"bytes,8,rep,name=producers,proto3" json:"producers,omitempty"`
...
func (x *Registration) GetProducers() []*Producer {
	if x != nil {
		return x.Producers
	}
	return nil
...
type Producer struct {
	...
	Exchange string `protobuf:"bytes,2,opt,name=exchange,proto3" json:"exchange,omitempty"` // TODO: do we need to add the exchange kind? (e.g. direct, topic, fanout, etc.)
}
...
type Consumer struct {
	...
	Kind ConsumerKind `protobuf:"varint,4,opt,name=kind,proto3,enum=core.aggregates.v1.ConsumerKind" json:"kind,omitempty"`
...
func (x *Consumer) Reset() {
	*x = Consumer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_aggregates_v1_registry_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Consumer) Descriptor() ([]byte, []int) {
	return file_core_aggregates_v1_registry_proto_rawDescGZIP(), []int{3}
}
...
var file_core_aggregates_v1_registry_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd1, 0x03, 0x0a, 0x0c, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x3a, 0x0a, 0x09, 0x70, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x65, 0x72, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63,
	0x6f, 0x72, 0x65, 0x2e, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x73, 0x2e, 0x76,
	0x31, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x72, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x65, 0x72, 0x73, 0x12, 0x3a, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65,
	0x72, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	...
	,
	...
	0x64, 0x12, 0x26, 0x0a, 0x08, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x72, 0x05, 0x10, 0x01, 0x18, 0xff, 0x01, 0x52,
	0x08, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x3a, 0x06, 0xba, 0xb9, 0x19, 0x02, 0x08,
	0x01, 0x22, 0xf1, 0x01, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x12, 0x26,
	...
	0x28, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x08, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x72, 0x05, 0x10,
	0x01, 0x18, 0xff, 0x01, 0x52, 0x08, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x2b,
	0x0a, 0x0b, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x72, 0x05, 0x10, 0x01, 0x18, 0xff, 0x01, 0x52,
	0x0a, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x3e, 0x0a, 0x04, 0x6b,
	0x69, 0x6e, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	...
	0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x20, 0x0a, 0x05, 0x71,
	0x75, 0x65, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x72,
	0x05, 0x10, 0x01, 0x18, 0xff, 0x01, 0x52, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x3a, 0x06, 0xba,
	0xb9, 0x19, 0x02, 0x08, 0x01, 0x2a, 0xa5, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
...
var file_core_aggregates_v1_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_core_aggregates_v1_registry_proto_goTypes = []interface{}{
	...
	(*Producer)(nil),     // 5: core.aggregates.v1.Producer
	(*Consumer)(nil),     // 6: core.aggregates.v1.Consumer
}
var file_core_aggregates_v1_registry_proto_depIdxs = []int32{
	...
	5, // 2: core.aggregates.v1.Registration.producers:type_name -> core.aggregates.v1.Producer
	6, // 3: core.aggregates.v1.Registration.consumers:type_name -> core.aggregates.v1.Consumer
	1, // 4: core.aggregates.v1.Protocol.kind:type_name -> core.aggregates.v1.ProtocolKind
	2, // 5: core.aggregates.v1.Consumer.kind:type_name -> core.aggregates.v1.ConsumerKind
...
func file_core_aggregates_v1_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_aggregates_v1_registry_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
