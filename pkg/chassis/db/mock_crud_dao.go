...
func (_m *MockCrudDao) Create(ctx context.Context, logger logging.Logger, model interface{}) (string, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, logging.Logger, interface{}) error); ok {
...
func (_m *MockCrudDao) CreateWithId(ctx context.Context, logger logging.Logger, id string, model interface{}) (string, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, logging.Logger, string, interface{}) error); ok {
...
func (_m *MockCrudDao) Delete(ctx context.Context, logger logging.Logger, params primitive.M) error {
	ret := _m.Called(ctx, logger, params)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, logging.Logger, primitive.M) error); ok {
...
func (_m *MockCrudDao) DeleteById(ctx context.Context, logger logging.Logger, id string) error {
	ret := _m.Called(ctx, logger, id)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, logging.Logger, string) error); ok {
		r0 = rf(ctx, logger, id)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockCrudDao) GenerateBase64URLEncodedId(logger logging.Logger) (string, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(logging.Logger) error); ok {
		r1 = rf(logger)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockCrudDao) InitializeCompositeUniqueIndex(logger logging.Logger, keys primitive.D) error {
	ret := _m.Called(logger, keys)

	var r0 error
	if rf, ok := ret.Get(0).(func(logging.Logger, primitive.D) error); ok {
		r0 = rf(logger, keys)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockCrudDao) Read(ctx context.Context, logger logging.Logger, params primitive.M, decodeModelCallback func([]byte, string) (interface{}, error), opts ...*options.FindOptions) ([]CrudDaoModel, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, logging.Logger, primitive.M, func([]byte, string) (interface{}, error), ...*options.FindOptions) error); ok {
...
func (_m *MockCrudDao) ReadById(ctx context.Context, logger logging.Logger, id string, decodeModelCallback func([]byte, string) (interface{}, error), opts ...*options.FindOptions) (CrudDaoModel, bool, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, logging.Logger, string, func([]byte, string) (interface{}, error), ...*options.FindOptions) error); ok {
...
func (_m *MockCrudDao) Update(ctx context.Context, logger logging.Logger, params primitive.M, model interface{}) error {
	ret := _m.Called(ctx, logger, params, model)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, logging.Logger, primitive.M, interface{}) error); ok {
...
func (_m *MockCrudDao) UpdateById(ctx context.Context, logger logging.Logger, id string, model interface{}) error {
	ret := _m.Called(ctx, logger, id, model)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, logging.Logger, string, interface{}) error); ok {
		r0 = rf(ctx, logger, id, model)
	} else {
		r0 = ret.Error(0)
	}
