...
replace github.com/jgkawell/galactus/pkg/chassis => ../../../pkg/chassis
...
require (
	...
	github.com/hashicorp/vault-client-go v0.4.0 // indirect
	...
	github.com/jgkawell/galactus/api/gen/go v1.0.0 // indirect
